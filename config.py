...
BOT_TOKEN = getenv("BOT_TOKEN", "6160676710:AAHqEJHt0wH72n4sCZ8DyjpUscJZTPJq0Sg")
BOT_NAME = getenv("BOT_NAME", "MisQueenBot")

API_ID = int(getenv("API_ID", "28179675"))
API_HASH = getenv("API_HASH", "420a98a8a48b10adaeaff5beaca48eb0)
MONGO_DB_URL = getenv("MONGO_DB_URL", "mongodb+srv://Cloner:Cloner@cluster0.cgc6t.mongodb.net/?retryWrites=true&w=majority")
OWNER_NAME = getenv("OWNER_NAME", "Pushkar")
OWNER_USERNAME = getenv("OWNER_USERNAME", "PushEditZ")
ALIVE_NAME = getenv("ALIVE_NAME", "MissQueen")
BOT_USERNAME = getenv("BOT_USERNAME", "MisQueenRobot")
OWNER_ID = getenv("OWNER_ID", "5610587277")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", ("MisQueenBot")
